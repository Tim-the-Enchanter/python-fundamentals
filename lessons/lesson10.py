# CAC-102-10 Lesson 10 Encapsulation
# Encapsulation in Python is considered weak as it is done by convention
# rather than enforced.

# Protected members use a single underscore and should not be accessed outside
...
# The property decorator annotation allows the creation of methods to replace the need
...
if __name__ == '__main__':
    ...
    # get the to_inches method again
    # print(measure.to_inches())
    pass
