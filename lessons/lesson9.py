# CAC-102-9 Lesson 9 Classes & Functions
...
# method is shared by all create objects
...
# using 8args and **kwargs will help define these arguments
...
# this is a tuple of colors
# *args takes a tuple in values, but not as a variable, You will generate
# an error if you push a tuple directly
# favs = ('red', 'green', 'blue', 'yellow', 'orange')
# favorite_color(favs)

# The arguments we pass into the function as a tuple, when executed creat
# the tuple inside the functio. This is why we can't pass a tuple directly.
...
# given default value. These default after other arguments
...
# compiler. It will perform all action in the file except funtions unless
