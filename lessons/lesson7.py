...
# Nested For Loops
# You can have a loop in side a loop. The inner loop can use the variable of the outer loop
# both must have different clear variables
def basic_nested():
...
# break statement
# This is used in conjunction with a if statement to break a loop
